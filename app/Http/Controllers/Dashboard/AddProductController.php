...
class AddProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.addProduct')->with('success', 'Add Product Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.showProducts')->with('success', 'Product updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dashboard.showProducts')->with('success', 'Product deleted successfully');
    }
}
