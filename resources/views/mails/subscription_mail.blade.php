  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
    ...
    <tr>
      <td style="padding: 35px;">
        ...
        <p>{{ $user_subscription->subscription->name }}  تم الاشتراك في  خدمة  </p>
        <p>EGP {{ $user_subscription->subscription->price }}  سعر الخدمة  </p>
        <p>{{ $user_subscription->end_date }}  تاريخ انتهاء </p>
